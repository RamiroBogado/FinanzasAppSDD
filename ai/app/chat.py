...
Reglas:
- Usá ÚNICAMENTE la información del contexto. Nunca inventes montos, fechas, categorías ni nombres.
...
- Si el contexto contiene datos relacionados con la pregunta, respondé con ellos; reservá "no tengo información suficiente" únicamente para cuando el contexto no menciona nada relacionado.
...
def build_reply(question: str, documents: list[str], llm=None) -> str:
