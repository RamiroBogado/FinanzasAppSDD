...
- **WHEN** el usuario autenticado visualiza su listado de transacciones sin filtros
- **THEN** el sistema muestra el total de ingresos, el total de gastos y el saldo calculados sobre todas sus transacciones con formato ARS
...
- **THEN** el listado y los totales reflejan únicamente las transacciones que cumplen el filtro

#### Scenario: Gastos por categoría
- **WHEN** el usuario autenticado visualiza su listado de transacciones
- **THEN** el sistema muestra el total de gastos de cada categoría presente con formato ARS
